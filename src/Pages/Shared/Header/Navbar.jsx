...
const Navbar = () => {
    const nav = <>
        <li className='text-base-300 font-semibold text-base'><NavLink>Services</NavLink></li>
        <li className='text-base-300 font-semibold text-base'><NavLink>Coverage</NavLink></li>
        <li className='text-base-300 font-semibold text-base'><NavLink>About Us</NavLink></li>
        <li className='text-base-300 font-semibold text-base'><NavLink>Pricing</NavLink></li>
        <li className='text-base-300 font-semibold text-base'><NavLink>Be a Rider</NavLink></li>
    </>
    return (
            ...
            <Container>
                <div className='navbar'>
                    ...
                    <div className="flex gap-3 items-center navbar-end">
                        <button className={`relative  inline-flex items-center cursor-pointer justify-start px-5 py-2 overflow-hidden font-bold rounded-lg group`}>
