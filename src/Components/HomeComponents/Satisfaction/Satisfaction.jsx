...
const Satisfaction = () => {
    ...
    return (
        <section className='max-w-[1280px] mx-auto px-2 md:px-3 lg:px-8 my-8 md:my-10 lg:my-14'>
            <div className="bg-secondary bg-[url(assets/be-a-merchant-bg.png)] bg-no-repeat rounded-3xl flex py-8 md:py-16 lg:py-20 px-4 md:px-12 lg:px-20">
                <div data-aos="fade-left" className="max-w-[670px]">
                    ...
                    <div className='flex gap-4 mt-8'>
                        <button className="btn btn-outline rounded-full btn-primary">Become a Merchant</button>
                        <button className="btn btn-outline rounded-full btn-primary">Earn with Profast Courier</button>
                    </div>
                </div>
